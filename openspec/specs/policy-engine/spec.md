...
## Purpose
YAML-defined policy engine for MCP proxy that evaluates incoming JSON-RPC requests against ordered rules before forwarding, supporting allow/deny/audit actions, method and tool name matching, and condition-based matching with operators.
